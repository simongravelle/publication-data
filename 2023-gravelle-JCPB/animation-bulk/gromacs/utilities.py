...
def extract_monomer_list(u):
    all_monomers = []
    grp_PEG = u.select_atoms("resname PEG")
    grp_PEG_O = u.select_atoms("type OC311 OC30A")
    ...
    for id_oxygen in grp_PEG_O.indices:
        ...
        for CO_bond in where_is_CO_bond:
            ...
            for CH_bond in where_is_CH_bond:
                ...
                if (atom_type == "HCA2") | (atom_type == "HCP1"):
        ...
        assert monomer.select_atoms("type OC311 OC30A").atoms.n_atoms == 1, "should be one oxygen"
